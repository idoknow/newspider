...
NewsCrawler.prototype.isOptionValid = function(option) {
	...
	*/
	...
	if(!('processResult' in option)) return false;
	if(!('shouldStopCrawl' in option)) return false;
...
NewsCrawler.prototype.startCrawl = async function() {
	this.processResult = this.option.processResult;
	this.shouldStopCrawl = this.option.shouldStopCrawl;
